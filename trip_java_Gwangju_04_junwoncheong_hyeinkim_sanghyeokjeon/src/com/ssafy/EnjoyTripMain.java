...
public class EnjoyTripMain {
	...
	private void attractionList() throws NumberFormatException, IOException {
		...
		List<AttractionInfoDto> list = AttractionServiceImpl.getAttractionService().attractionList(attractionInfoDto);
		for (AttractionInfoDto info : list) {
	...
	private void attractionSearch() throws IOException {
		...
		List<AttractionInfoDto> list = AttractionServiceImpl.getAttractionService().searchByTitle(title, sidoCode);
		for (AttractionInfoDto info : list) {
			System.out.println(info);
		}
...
//
//		attractionInfoDtos = attractionServiceImpl.searchByTitle(title, sidoCode);
//
//		for (AttractionInfoDto attractionInfoDto : attractionInfoDtos) {
